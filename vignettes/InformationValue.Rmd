...
Here are the first 50 rows of the resulting sensitivity matrix. The 'TPR' and 'FPR' are obtained for probability cutoff scores starting from 1 to 0 in steps of -0.02. 
